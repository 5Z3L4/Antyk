...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        {
            Vector3 pixel_pos = WorldToPixelCoordinates(world_point);
            Debug.Log(pixel_pos);
            ...
            if (previous_drag_position == Vector2.zero)
            {
                ...
                ColourPixels(pixel_pos, Pen_Width, Pen_Colour);
            }
            else
            {
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                // Check if the ray intersects with any 3D collider in the specified layer
                if (Physics.Raycast(ray, out RaycastHit hit, Mathf.Infinity, Drawing_Layers.value))
                {
                    PenBrush(hit.point);
                }
                else
        ...
        public void ColourBetween(Vector2 start_point, Vector2 end_point, int width, Color color)
        {
            ...
            for (float lerp = 0; lerp <= 1; lerp += lerp_steps)
            {
                ...
                ColourPixels(cur_position, width, color);
            }
        }
        ...
        public Vector3 WorldToPixelCoordinates(Vector3 world_position)
        {
